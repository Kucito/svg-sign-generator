...
export default function Home() {
  //States
  const [width, setWidth] = useState(220 * MM)
  const [height, setHeight] = useState(40 * MM)
  const [fontSize, setFontSize] = useState(30 * MM)
  ...
  const handleDownload = () => {
    console.log(svgFile.current.outerHTML)
  ...
  return <main className={`flex min-h-screen flex-col items-center justify-start p-24`
    ...
    <svg xmlns="http://www.w3.org/2000/svg" ref={svgFile} viewBox={`0 0 ${width} ${height}`} width={`${width / MM}mm`} height={`${height / MM}mm`}>
      ...
      <path transform={`translate(${width},${height - 5}) scale(${width * 0.01}) rotate(180)`} fill="black" d={ornaments[ornament]} />

      <rect x={`${(width - width * 0.05)}`} y={`0`} width={width * 0.05} height={height} fill={`white`} />
      <rect x={`0`} y={`0`} width={width * 0.05} height={height} fill={`white`} />
      <circle cx={svgMetrics.x / 2} cy={height / 2} r="1" stroke="blue" fill="blue" />
      <circle cx={width - svgMetrics.x / 2} cy={height / 2} r="1" stroke="blue" fill="blue" />
    ...
    <table className="table-auto">
      <tbody>
        ...
        <tr>
          <td>
            <input type="number" value={parseInt(fontSize / MM)} onChange={(e) => { setFontSize(e.target.value * MM) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00" />
          </td>
          <td>
            <button onClick={() => { setFontSize(prevState => prevState + MM) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00">+</button>
          </td>
          <td>
            <button onClick={() => { setFontSize(prevState => prevState - MM) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00">-</button>
          </td>
        ...
        <tr>
          <td>
            <input type="text" value={text} onChange={(e) => { setText(e.target.value.toUpperCase()) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00" />
          </td>
        </tr>
        <tr>
          <td>
            <input type="number" value={ornament} onChange={(e) => { setOrnament(e.target.value) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00" />
          </td>
          <td>
            <button onClick={() => { setOrnament(prevState => prevState + 1) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00">+</button>
          </td>
          <td>
            <button onClick={() => { setOrnament(prevState => prevState - 1) }} className="block text-center text-[1rem] rounded-md border-0 py-1.5 pl-7 pr-7 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="0.00">-</button>
          </td>
